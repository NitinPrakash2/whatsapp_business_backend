...
//
async function getBaileysClient(_$v, instanceId, number) {
    const key = `${instanceId}:${number}`;
...
//
async function initClient(_$v, instanceId, number, key) {
